...
class ConceptImportImageTests(TestCase):
    def test_one_image_import_has_deterministic_collection_covers(self):
        ...
        self.assertEqual(ProductImage.objects.filter(provenance_status="representative_demo").count(), 24)
